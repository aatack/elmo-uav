...
The wing assembly (Figure \ref{fig:wing-exploded-assy}) is comprised of two carbon spars placed respectively at quarter and half chord, and extending for the entire \metres{2} wingspan, each half of the wing containing three ribs (Figure \ref{fig:ribs}).  % REFER TO: wing-exploded-assy
...
\importimage{wing-exploded-assy}{exploded wing assembly.}{Wing assembly}{0.95}
...
It can also be seen that the stress on the carbon fibre tail boom reaches over 2 MPa, but this is well below the yield stress of the carbon tube which will be over 600 MPa based on the properties quoted by the provider. % TODO: [Performance Composites [REF]]. 
...
\importimage{landing-leg-simulation}{FEA simulation of the landing gear.}{Landing gear FEA}{0.5}
...
\importimage{wiring-diagram}{wiring diagram for the avionics subsystem.}{Wiring diagram}{0.7}
